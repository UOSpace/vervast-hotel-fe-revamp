...
export function DashboardPage() {
  ...
  return (
    <div className="w-full h-full flex flex-col pt-4 lg:pt-6 overflow-x-hidden">
      {/* Header */}
      <header className="shrink-0 flex justify-between items-start mb-4 px-4 lg:px-6">
        <div>
          <h1 className="text-4xl font-serif text-[#4a3c31] mb-1">
            Global Snapshot.{' '}
            {view === 'by_resort_type' && (
              <span className="text-xl font-serif text-[#7d6b5e] italic">by Resort Type.</span>
            )}
          </h1>
          {view === 'all' && (
      ...
      {view === 'by_resort_type' ? (
        ...
        <div key="all" className="flex-1 min-h-0 grid grid-cols-12 grid-rows-[auto_1fr_1fr_1fr] gap-4 overflow-y-auto pb-6 px-4 lg:px-6 text-[10px] custom-scrollbar">

          {/* ROW 1: Map (col 1-7) & Metrics (col 8-12) */}
          <div 
            className="col-span-7 row-span-2 border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col backdrop-blur-sm animate-card-enter cursor-pointer hover:ring-2 hover:ring-[#C8A050]/50 transition-all" 
            style={{ animationDelay: '0.1s' }}
            onClick={() => openDrawer({ type: 'LIVE_OVERVIEW', title: 'Live Overview' })}
          >
            <LiveOverviewMap />
          </div>
          ...
          <div className="col-span-5 row-span-1 grid grid-cols-4 gap-4">
            <div 
              className="border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col backdrop-blur-sm animate-card-enter cursor-pointer hover:ring-2 hover:ring-[#C8A050]/50 transition-all" 
              style={{ animationDelay: '0.15s' }}
              onClick={() => openDrawer({ type: 'METRIC', title: dashboardData.metrics.guestsToday.title })}
            >
              <MetricWidget
            ...
            <div 
              ...
              onClick={() => openDrawer({ type: 'METRIC', title: dashboardData.metrics.occupancy.title })}
            >
              <MetricWidget
            ...
            <div 
              ...
              onClick={() => openDrawer({ type: 'METRIC', title: dashboardData.metrics.revPar.title })}
            >
              <MetricWidget
            ...
            <div 
              ...
              onClick={() => openDrawer({ type: 'METRIC', title: dashboardData.metrics.avgLengthOfStay.title })}
            >
              <MetricWidget
          ...
          <div 
            className="col-span-5 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col backdrop-blur-sm animate-card-enter cursor-pointer hover:ring-2 hover:ring-[#a65e52]/50 transition-all" 
          ...
          {/* ROW 3 */}
          <div 
            className="col-span-5 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col backdrop-blur-sm animate-card-enter cursor-pointer hover:ring-2 hover:ring-[#C8A050]/50 transition-all" 
            style={{ animationDelay: '0.4s' }}
            onClick={() => openDrawer({ type: 'GUEST_MOVEMENT', title: 'Guest Movement' })}
          >
            <GuestMovementWidget />
          </div>
          <div 
            className="col-span-3 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col backdrop-blur-sm animate-card-enter cursor-pointer hover:ring-2 hover:ring-[#C8A050]/50 transition-all" 
          ...
          <div 
            className="col-span-2 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col backdrop-blur-sm animate-card-enter cursor-pointer hover:ring-2 hover:ring-[#C8A050]/50 transition-all" 
          ...
          {/* ROW 4 */}
          <div className="col-span-3 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col backdrop-blur-sm animate-card-enter" style={{ animationDelay: '0.6s' }}>
            <GuestArrivalsWidget />
          </div>

          {/* Top Guest Needs */}
          <div className="col-span-3 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 flex flex-col justify-between backdrop-blur-sm animate-card-enter" style={{ animationDelay: '0.65s' }}>
            <div className="mb-2">
          ...
          <div className="col-span-6 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 flex space-x-4 backdrop-blur-sm animate-card-enter" style={{ animationDelay: '0.7s' }}>
          ...
          <div className="col-span-5 row-span-1 flex gap-4 animate-card-enter" style={{ animationDelay: '0.75s' }}>
          ...
          <div className="col-span-4 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 backdrop-blur-sm flex flex-col justify-between animate-card-enter" style={{ animationDelay: '0.8s' }}>
            <div>
          ...
          <div className="col-span-3 row-span-1 border border-[#d4c4b7] rounded-[12px] p-4 backdrop-blur-sm flex flex-col justify-between animate-card-enter" style={{ animationDelay: '0.85s' }}>
