      ...
      <div className="flex-1 min-h-0 flex flex-col px-4 lg:px-6 pb-6">
        ...
        >
          ...
          <div className="p-3 border-t border-[#d4c4b7] flex justify-between items-center bg-[#f3eae1]/80 text-xs text-[#7d6b5e]">
            <span>
              Showing <span className="font-medium text-[#4a3c31]">{filteredAgencies.length}</span> of{' '}
              <span className="font-medium text-[#4a3c31]">{mockAgencies.length}</span> agencies
            </span>
            <div className="flex gap-1">
              <Button variant="ghost" size="sm" className="h-7 text-[#4a3c31] hover:bg-[#d4c4b7]/30 opacity-50 cursor-not-allowed">
                Previous
              </Button>
              <Button variant="ghost" size="sm" className="h-7 text-[#4a3c31] hover:bg-[#d4c4b7]/30 opacity-50 cursor-not-allowed">
                Next
